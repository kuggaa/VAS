...
{
	public class TextViewBinding : PropertyBinding<string>
	{
		TextView textView;
		bool inChange;

		public TextViewBinding (TextView textView, Expression<Func<IViewModel, string>> propertyExpression) : base (propertyExpression)
		{
