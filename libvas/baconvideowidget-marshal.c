...
/* VOID:INT64,INT64,DOUBLE (./baconvideowidget-marshal.list:4) */
extern void baconvideowidget_marshal_VOID__INT64_INT64_DOUBLE (GClosure     *closure,
                                                               GValue       *return_value,
                                                               guint         n_param_values,
                                                               const GValue *param_values,
                                                               gpointer      invocation_hint,
                                                               gpointer      marshal_data);
void
baconvideowidget_marshal_VOID__INT64_INT64_DOUBLE (GClosure     *closure,
                                                   GValue       *return_value G_GNUC_UNUSED,
                                                   guint         n_param_values,
                                                   const GValue *param_values,
                                                   gpointer      invocation_hint G_GNUC_UNUSED,
                                                   gpointer      marshal_data)
{
  typedef void (*GMarshalFunc_VOID__INT64_INT64_DOUBLE) (gpointer     data1,
                                                         gint64       arg_1,
                                                         gint64       arg_2,
                                                         gdouble      arg_3,
                                                         gpointer     data2);
  register GMarshalFunc_VOID__INT64_INT64_DOUBLE callback;
  register GCClosure *cc = (GCClosure*) closure;
  register gpointer data1, data2;
  ...
  callback = (GMarshalFunc_VOID__INT64_INT64_DOUBLE) (marshal_data ? marshal_data : cc->callback);
