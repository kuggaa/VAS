...
namespace VAS.UI
{
	...
	public partial class CapturerBin : Gtk.Bin, ICapturerBin
	{
		...
		public CapturerBin ()
		{
			...
			recimage.Image = App.Current.ResourcesLocator.LoadIcon ("longomatch-control-record",
				StyleConf.PlayerCapturerIconSize);
			stopimage.Image = App.Current.ResourcesLocator.LoadIcon ("longomatch-stop",
				StyleConf.PlayerCapturerIconSize);
			pauseimage.Image = App.Current.ResourcesLocator.LoadIcon ("longomatch-pause-clock",
				StyleConf.PlayerCapturerIconSize);
			resumeimage.Image = App.Current.ResourcesLocator.LoadIcon ("longomatch-resume-clock",
				StyleConf.PlayerCapturerIconSize);
			saveimage.Image = App.Current.ResourcesLocator.LoadIcon ("longomatch-save",
				StyleConf.PlayerCapturerIconSize);
			cancelimage.Image = App.Current.ResourcesLocator.LoadIcon ("longomatch-cancel-rec",
				StyleConf.PlayerCapturerIconSize);
			deletelastimage.Image = App.Current.ResourcesLocator.LoadIcon ("longomatch-delete",
				StyleConf.PlayerCapturerIconSize);
			playlastimage.Image = App.Current.ResourcesLocator.LoadIcon ("longomatch-control-play",
				StyleConf.PlayerCapturerIconSize);
