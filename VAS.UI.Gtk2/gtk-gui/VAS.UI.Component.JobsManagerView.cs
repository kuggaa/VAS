...
namespace VAS.UI.Component
{
	public partial class JobsManagerView
	{
		...
		protected virtual void Build ()
		{
			...
			// Widget VAS.UI.Component.JobsManagerView
			global::Stetic.BinContainer.Attach (this);
			this.WidthRequest = 500;
			this.HeightRequest = 250;
			this.Name = "VAS.UI.Component.JobsManagerView";
			// Container child VAS.UI.Component.JobsManagerView.Gtk.Container+ContainerChild
