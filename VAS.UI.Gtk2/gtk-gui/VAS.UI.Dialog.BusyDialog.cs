...
namespace VAS.UI.Dialog
{
	public partial class BusyDialog
	{
		...
		protected virtual void Build()
		{
			...
			// Widget VAS.UI.Dialog.BusyDialog
			this.Name = "VAS.UI.Dialog.BusyDialog";
			this.WindowPosition = ((global::Gtk.WindowPosition)(4));
			// Internal child VAS.UI.Dialog.BusyDialog.VBox
			global::Gtk.VBox w1 = this.VBox;
			w1.Name = "dialog1_VBox";
			w1.BorderWidth = ((uint)(2));
			// Internal child VAS.UI.Dialog.BusyDialog.ActionArea
